    ...
    <section>
      <Element name="pricing">
        <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            ...
            <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]">
              <button
                ...
                // base-bold relative z-2 h-16 flex-1 uppercase text-p5 transition-colors duration-500 hover:text-p4
            ...
            <div className="pricing-bg">
              {/* pointer-events-none absolute -bottom-16 left-[calc(50%-480px)] z-2 mx-auto w-960 */}
              <img
                src="bg-outlines (1).svg"
                width={960}
                height={380}
                alt="outline"
          ...
          {/*  pricing section*/}
          <div className="scroll-hide relative z-2 -mt-32 ml-16 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
            {plans.map((plan, index) => (
              <div key={plan.id} className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]">
                ...
                >
                  <img src={plan.logo} alt={plan.title} className={clsx("object-contain drop-shadow-xl", index === 1 ? "size-[120px]" : "size-[88px]",)}
                  />
                </div>
                ...
                <div className={clsx("relative flex  flex-col items-center", index === 1 ? "pt-24" : "pt-12",)}>
                  ...
                  <div className="relative z-2 flex items-center justify-center">
                    <div className={clsx("h-num  flex items-start", index === 1 ? "text-p3" : "text-p4",)}>
                      ${" "}
                      <CountUp start={plan.priceMonthly} end={monthly ? plan.priceMonthly : plan.priceYearly} duration={0.6} useEasing={false} preserveValue />
